...
class LocationOrderDetailsScreen extends StatelessWidget {
  ...
  void _loadData(BuildContext context) async {
    ...
    Provider.of<LocationOrderProvider>(context, listen: false).getLocationOrderDetails(orderModel.id.toString(), context);
  }
                          ...
                          action: () {
                            _checkPermission(context, () {
                              ...
                              Provider.of<OrderProvider>(context, listen: false)
                                  .updateOrderStatus(token: token, orderId: orderModel.id, status: 'out_for_delivery', index: null);
                        ...
                        child: SliderButton(
                          action: () {
                            ...
                            if (orderModel.paymentStatus == 'paid') {
                              ...
                              Provider.of<OrderProvider>(context, listen: false)
                                  .updateOrderStatus(token: token, orderId: orderModel.id, status: 'delivered', index: null);
