...
import 'package:recyminer_miner/helper/date_converter.dart';
...
import 'package:recyminer_miner/view/screens/order/widget/custom_divider.dart';
import 'package:recyminer_miner/view/screens/order/widget/permission_dialog.dart';
import 'package:recyminer_miner/view/screens/order/widget/slider_button.dart';
import 'package:url_launcher/url_launcher.dart';

class LocationOrderDetailsScreen extends StatelessWidget {
  final OrderModel orderModel;
  LocationOrderDetailsScreen({this.orderModel});

  void _loadData(BuildContext context) async {
    await Provider.of<OrderProvider>(context, listen: false)
        .initializeTimeSlot(context);
    Provider.of<LocationOrderProvider>(context, listen: false)
        .getLocationOrderDetails(orderModel.id.toString(), context);
  }
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          if (order.orderDetails != null) {
            ...
            _timeSlot = order.timeSlots
                .firstWhere((timeSlot) => timeSlot.id == orderModel.timeSlotId);
          }
                          ...
                          Row(children: [
                            ...
                            Text(
                                DateConverter.convertTimeRange(
                                    _timeSlot.startTime, _timeSlot.endTime),
                                style: rubikMedium),
                          ]),
